...
> For spatial sampling
 ...
 3. Trap placement within plots were either randomized or taregeted depending on the vegetation.
...
> Answer: Box plot is the better visualization option because in this instance we do not have sufficient information to estmiate the density of the dry Mass of the various functional groups.

What type(s) of litter tend to have the highest biomass at these sites?

> Answer: Needles followed by Mixed then to have the highest biomass
