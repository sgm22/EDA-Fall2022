...
lake.chemistry <- read.csv("./Data/Raw/NTL-LTER_Lake_ChemistryPhysics_Raw.csv", stringsAsFactors = TRUE)
...
> Answer: Based on the results on the model, 73.87% of the variability in temperature is explained by changes in depth. The degrees of freedom on which this finding is based is 9726. The p-value for this model is  <0.001.
...
lake.chemistry.mod.all.2 <- lm(data = processed.lake.chemistry, 
                               temperature_C ~ daynum + depth)

step(lake.chemistry.mod.all.2)
summary (lake.chemistry.mod.all.2)
