...
local_water_supply <- data.frame("Month" = c("Jan", "May", "Sept", "Feb", "Jun",
...
local_water_supply_reorder <- local_water_supply %>% arrange(factor(Month, levels = c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sept","Oct","Nov", "Dec")))

local_water_supply_reorder #Check dataset

local_water_supply_reorder$Date <- ymd(local_water_supply_reorder$Date)


#5. Create line plot of maximum daily withdrawals

ggplot(local_water_supply_reorder, aes(x = Date, y = max.withdrawals.mgd)) +
  geom_line(aes(group = 1)) +
  ylab ("Maximum Daily Withdrawals/ mgd") +
  xlab ("Month of the Year") +
  labs(title = paste ("Max Daily Water Withdrawals"))
...
water_supply_reorder <- water_supply %>% arrange(factor(Month, levels = c("Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sept","Oct","Nov", "Dec")))

  #Return the dataframe
  return(water_supply_reorder)
}
...
local_water_supply_2015 <- scrape_website(03-32-010,2015)
local_water_supply_2015

# Line plot of maximum daily withdrawals 

ggplot(local_water_supply_2015, aes(x = Date, y = max.withdrawals.mgd)) +
  geom_line(aes(group = 1)) +
  ylab ("Maximum Daily Withdrawals/ mgd") +
  xlab ("Month of the Year") +
  labs(title = paste ("Max Daily Water Withdrawals 2015"))
...
local_water_supply_2015_Asheville
```
