...
temp.plot <- ggplot(lake_chemistry, aes(x = month.abb[month], y= temperature_C)) +
...
nitrogen.plot <- ggplot(lake_chemistry, aes (x = month.abb[month], y = tn_ug)) +
  geom_boxplot (aes(color = lakename)) +
  xlab ("Month") +
...
phosphorus.plot <- ggplot(lake_chemistry, aes (x = month.abb[month], y = tp_ug)) +
  geom_boxplot (aes(color = lakename)) +
  xlab ("Month") +
...
#Creating plots and store in variable without legend

t.plot <- ggplot(lake_chemistry, aes (x = month.abb[month], y= temperature_C)) +
  geom_boxplot (aes(color = lakename))+
   ylab ("Temperature/ degrees in Celsius") +
  xlab ("") +
  theme (legend.position = "none")

n.plot <- ggplot(lake_chemistry, aes (x = month.abb[month], y = tn_ug)) +
  geom_boxplot (aes(color = lakename)) +  
  ylab ("Total Nitrogen/ug") +
  xlab ("") +
  theme (legend.position = "none") 

p.plot <- ggplot(lake_chemistry, aes (x = month.abb[month], y = tp_ug)) +
  geom_boxplot (aes(color = lakename)) + 
  ylab ("Total phosphorous/ ug") +
  theme (legend.position = "none") +
  xlab ("")
...
legend <- get_legend(t.plot + 
                       theme(legend.position = "bottom"))

unified_plot <- plot_grid(t.plot, n.plot,p.plot, labels = c ("Months"), label_y = 2, align = "v", rel_widths = c(5, 5), ncol = 3) 
   
 

plot_grid(unified_plot)
