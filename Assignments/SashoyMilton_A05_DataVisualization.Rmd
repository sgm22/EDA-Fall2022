...
lake_chemistry <- read.csv("../Data/Processed/NTL-LTER_Lake_Chemistry_Nutrients_PeterPaul_Processed.csv")
...
#4. Plot of total phosphorus by phosphate
  ...
  ggplot(lake_chemistry, aes(x = tp_ug, y = po4, color=factor(lakename))) +
  geom_point() +
...
ggplot(subset_litter_dat,aes(x = month(collectDate), y = dryMass, color = factor(nlcdClass))) +
  geom_point() +
