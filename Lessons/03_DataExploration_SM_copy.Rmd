...
str(USGS.flow.data) #Shows what are the character types of the variables included in the data types
...
```{r Fixing dates}
# Converts date back to character
USGS.flow.data$datetime <- format(USGS.flow.data$datetime, "%y%m%d")

#Creating a function the replaces the 20 with 19 if the date is greater than December 19, 2026.
create.early.dates <- (function(d) {
       paste0(ifelse(d > 191226,"19","20"),d)
       })

#Use the function created to make the replacement
USGS.flow.data$datetime <- create.early.dates(USGS.flow.data$datetime)

#Converts date back into year, month,day format
