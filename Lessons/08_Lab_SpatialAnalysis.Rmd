...
st_crs(huc8_sf) #Check the CRS of the data set


#The CRS that this data set uses is WGS 84
...
mapview(huc8_sf, col.region = 'orange', alpha.regions = 1)+
...
ggplot (data = huc8_sf_join_) +
  geom_sf(aes(fill = SumWindEnergy))

#or 

mapView(huc8_sf_join_, zcol = "SumWindEnergy")
