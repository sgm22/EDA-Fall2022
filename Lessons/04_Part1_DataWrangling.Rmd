...
# Format sampledate as date seen in the imported element this includes the /. Be mindful that month, day and year could be separated by -. Indicate that this is the separator in this case.
