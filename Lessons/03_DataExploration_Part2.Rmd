...
# Check our date column as csv files ALWAYS stores date as character. 
class(USGS.flow.data$datetime)

# Change date from character to date format. This important as we may want to order data by date.
...
ggplot(USGS.flow.data) +
  ...
  geom_freqpoly(aes(x = gage.height.max), bins = 50,  lty = 2) +   #lty means line type
...
#Shows variance/spread across the distribution of our data.
ggplot(USGS.flow.data) +
